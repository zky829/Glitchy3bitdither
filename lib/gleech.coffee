...
Caman.Filter.register 'randomColorShift', ->
  r = Caman.Calculate.randomRange(-100,100)
  g = Caman.Calculate.randomRange(-100,100)
  b = Caman.Calculate.randomRange(-100,100)
  @channels red: r, blue: b, green: g

Caman.Filter.register 'randomRedShift', ->
  @channels red: Caman.Calculate.randomRange(-100,100)

Caman.Filter.register 'randomBlueShift', ->
  @channels blue: Caman.Calculate.randomRange(-100,100)

Caman.Filter.register 'randomGreenShift', ->
  @channels green: Caman.Calculate.randomRange(-100,100)
