(function() {
  var ArrayToCanvas, Caman, Canvas, andSort, numericSort, orSort, randminmax, randomSort, slice_range, sum, swapEnd32, xorSort,
  ...
  ArrayToCanvas = function(arr, width, height) {
    var buff, can, ctx, data, i, imgdata, k, len, middle, pixel, pixelData;
    ...
    middle = (width * height * 4) / 2;
    console.log("Spot-check");
    data = ctx.getImageData(0, 0, width, height);
    console.log("data: ", data.data[middle], data.data[middle + 1], data.data[middle + 2], data.data[middle + 3]);
    console.log("buff: ", buff[middle], buff[middle + 1], buff[middle + 2], buff[middle + 3]);
    return can;
  };
