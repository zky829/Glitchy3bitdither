(function() {
  ...
  Caman.Filter.register('pixelate2', function(pixelation) {
    if (pixelation == null) {
      pixelation = 5;
    }
    return this.process('pixelate2', function(rgba) {
      var k, n, ref, results, that;
      that = this;
      results = [];
      for (n = k = 0, ref = pixelation; 0 <= ref ? k < ref : k > ref; n = 0 <= ref ? ++k : --k) {
        results.push((function(that) {
          var l, loc, m, ref1, results1;
          results1 = [];
          for (m = l = 0, ref1 = pixelation; 0 <= ref1 ? l < ref1 : l > ref1; m = 0 <= ref1 ? ++l : --l) {
            loc = that.locationXY();
            results1.push(that.putPixel(loc.x + n, loc.y + m, rgba));
          }
          return results1;
        })(that));
      }
