(function() {
  ...
  arrayToCanvas = function(arr, width, height) {
    var buff, can, ctx, ctxData, i, imgdata, k, len, pixel, pixelData;
  ...
  Caman.Filter.register('ditherShuffle', function() {
    var count;
    count = 0;
    return this.process('ditherShuffle', function() {
      var loc, pxl, x, y;
      count++;
      if (count % 2) {
        loc = this.locationXY();
